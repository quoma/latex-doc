...
\begin{abstract}
Магистерская диссертация содежрит \pageref{LastPage} страниц, 79 иллюстрации, список использованных источников -- 15 наименований. Использованы следующие ключевые слова:
