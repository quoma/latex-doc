...
\begin{abstract}
Магистерская диссертация содежрит \pageref{LastPage} страниц, 69 иллюстраций, список использованных источников -- 15 наименований. Использованы следующие ключевые слова:
...
Целью диссертации является анализ процесса развития устойчивости к противомикробным препаратам в больничной среде для изучения распространия устойчивых бактерий из больниц во внешнее общество.
