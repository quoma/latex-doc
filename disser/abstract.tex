\begin{abstract}
    ...
    The objective of the dissertation was to analyse the process of antimicrobial resistance development in a hospital environment in order to understand how the resistant bacteria strain gets spread from a group of individuals inside a hospital to the external society.

    The result of the research is a mathematical model that was consequently transferred to a computer simulation environment and executed under different parameter settings. Some important properties of the model were discussed and analysed in the latter chapters.
...
Зерттеудің нәтижесінде математикалық модель ұсынылып, компьютерлік эмуляцияға арналған модельге айналдырылып, параметрларының әр-түрлі мәндерімен жүргізілген. Диссертацияның соңғы тарауларында модельдің кейбір ерекшеліктері қарастырылып талданған.
